/*
 *Library of functions for lattice KMC simulations and otherwise.
 *C++ implementations, making them classes.
 */
...
class Langevin_dynamics
{
	...
	double propagate_dynamics(double, double, double, double) ;
	void compute_forces() ;
